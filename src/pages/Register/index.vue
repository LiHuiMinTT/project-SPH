...
export default {
  ...
  methods: {
    ...
    async regist() {
      const { phoneNumber, password, checkPassword } = this.registerInfo;
      try {
        ...
        this.isChecked &&
        this.checkCode &&
        await this.$store.dispatch("userModule/reqRegister", {
          phone: phoneNumber,
          code: this.checkCode,
          password,
        });
